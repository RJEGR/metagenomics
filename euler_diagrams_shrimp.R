...
sum(rowSums(euler) > 1) # continue with comparison per group using those 72 taxa
sum(rowSums(euler) == 1) #make a heatmap of exclusive taxa
...
save(intersected_taxa, exclusive_taxa, file = paste0(dir, "euler_outputs.RData"))
